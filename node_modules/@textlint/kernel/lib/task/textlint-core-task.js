...
var _promiseEventEmitter = require("./promise-event-emitter");
...
}(_promiseEventEmitter.PromiseEventEmitter);
...
var TextLintCoreTask = function (_EventEmitter) {
    ...
    _createClass(TextLintCoreTask, [{
        ...
        value: function tryToGetRuleObject(ruleCreator, ruleContext, ruleOptions) {
            try {
        ...
        value: function tryToAddListenRule(ruleCreator, ruleContext, ruleOptions) {
            var _this6 = this;
