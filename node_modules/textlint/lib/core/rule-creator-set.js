...
var RuleCreatorSet = function () {
    ...
    _createClass(RuleCreatorSet, [{
        key: "toKernelRulesFormat",
        value: function toKernelRulesFormat() {
            var _this = this;
        ...
        value: function withoutDuplicated() {
            ...
            this.ruleNames.forEach(function (ruleName) {
                var rule = _this2.rules[ruleName];
                var ruleConfig = _this2.rulesConfig[ruleName];
        ...
        value: function forEach(handler) {
            ...
            return this.ruleNames.forEach(function (ruleName) {
                return handler({
                    ruleId: ruleName,
                    rule: _this3.rules[ruleName],
                    ruleConfig: _this3.rulesConfig[ruleName]
                });
            });
        }
    }, {
        ...
        value: function getFixerNames() {
            ...
            return this.ruleNames.filter(function (ruleName) {
                return (0, _ruleCreatorHelper.hasFixer)(_this4.rules[ruleName]);
            });
        }
    }, {
        key: "mapFixer",
        value: function mapFixer(mapHandler) {
            ...
            return this.getFixerNames().map(function (ruleName) {
                var rules = _defineProperty({}, ruleName, _this5.rules[ruleName]);
                var rulesConfig = _defineProperty({}, ruleName, _this5.rulesConfig[ruleName]);
