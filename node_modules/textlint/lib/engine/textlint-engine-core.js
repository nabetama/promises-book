...
var _executeFileBackerManager = require("./execute-file-backer-manager");

var _executeFileBackerManager2 = _interopRequireDefault(_executeFileBackerManager);

var _cacheBacker = require("./execute-file-backers/cache-backer");

var _cacheBacker2 = _interopRequireDefault(_cacheBacker);
...
var TextLintEngineCore = function () {
    ...
    function TextLintEngineCore(options) {
         ...
         * @private
         */
        this.executeFileBackerManger = new _executeFileBackerManager2.default();
        var cacheBaker = new _cacheBacker2.default(this.config);
         ...
         * @private
         */
        this.pluginMap = new _processorMap2.default();
        /**
        ...
        this.moduleLoader.on(_textlintModuleLoader2.default.Event.plugin, function (_ref5) {
    ...
    _createClass(TextLintEngineCore, [{
        ...
        value: function executeOnFiles(files) {
            ...
            var patterns = (0, _findUtil.pathsToGlobPatterns)(files, {
                extensions: this.availableExtensions
            });
            var targetFiles = (0, _findUtil.findFiles)(patterns);
            ...
            var _separateByAvailabili = (0, _findUtil.separateByAvailability)(targetFiles, {
                extensions: this.availableExtensions
            }),
