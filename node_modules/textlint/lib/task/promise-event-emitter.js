...
exports.PromiseEventEmitter = undefined;
...
var PromiseEventEmitter = exports.PromiseEventEmitter = function (_EventEmitter) {
    _inherits(PromiseEventEmitter, _EventEmitter);

    function PromiseEventEmitter() {
        _classCallCheck(this, PromiseEventEmitter);

        return _possibleConstructorReturn(this, (PromiseEventEmitter.__proto__ || Object.getPrototypeOf(PromiseEventEmitter)).apply(this, arguments));
    }

    _createClass(PromiseEventEmitter, [{
        key: "once",
